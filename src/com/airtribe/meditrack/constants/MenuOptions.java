...
public class MenuOptions {
    ...
    public static final String MAIN_MENU = "      MAIN CONSOLE MENU      ";
    public static final String BILLING_MANAG_MENU = "1. Billing Management";
    ...
    public static final String GENERATE_BILL_APPNT_ID = "2. Generate Bill through Appointment Id";
    public static final String VIEW_BILL_SUMMARY = "3. View Bill Summary";
    ...
    public static final String THANKYOU_GOODBYE = "Thank you for using the system. Goodbye!";

    public static final String ENTER_CHOICE= "Please enter your choice";

    public static final String INVALID_ENTRY = "Error: Invalid entry. Please enter a number between ";
    public static final String INVALID_NUMBER = " Invalid number entered: ";
